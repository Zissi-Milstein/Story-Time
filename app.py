...
try:
    ...
    tts = TTS(model_path="Zissi-Milstein/Story-Time/blob/main/XTTS-v2/model.pth", config_path="Zissi-Milstein/Story-Time/blob/main/XTTS-v2/config.json", progress_bar=False, gpu=False)
